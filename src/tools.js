...
function showHitokoto() {
    ...
    fetch("https://v1.hitokoto.cn")
        ...
        .then(result => {
            const text = `這句名言是來自 <span>「${result.from}」</span>，是 <span>${result.creator}</span> 在 hitokoto.cn 投稿的。`;
...
const tools = {
    ...
    "photo": {
        ...
        callback: () => {
            showMessage("我把我最美麗的樣子留給你，是不是很萌阿！", 6000, 9);
    ...
    "quit": {
        ...
        callback: () => {
            ...
            showMessage("記得支持凡影Lifer_Lighdow，你的支持就是我們的最大動力。", 2000, 11);
